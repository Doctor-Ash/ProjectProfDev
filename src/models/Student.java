...
public Student(int vehicle_id, String make, String model, int
...
//Initialise instance variables here..
 ...
 public Student( String make, String model, int
year, int price, String license_number, String colour, int
number_doors, String transmission, int mileage, String fuel_type,
int engine_size, String body_style, String condition, String
notes) {
...
public String toString() {
	return "Vehicle [vehicle_id=" + vehicle_id + ", make=" + make + ", model=" + model + ", year=" + year + ", price="
			+ price + ", license_number=" + license_number + ", colour=" + colour + ", number_doors=" + number_doors
			+ ", transmission=" + transmission + ", mileage=" + mileage + ", fuel_type=" + fuel_type + ", engine_size="
			+ engine_size + ", body_style=" + body_style + ", condition=" + condition + ", notes=" + notes + "]";
}
}
